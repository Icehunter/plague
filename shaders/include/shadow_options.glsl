...
#define RT_SHADOWS 1 //[0 1] compile "Realistic Shadows" {0="Off" 1="On"}
#define u_RtShadowDistance 2 //[1..16 step 1] runtime "Realistic Shadow Distance"
...
#define SHADOW_RESOLUTION 1024 //[1024 2048 4096] compile "Shadow Sharpness" {1024="1024" 2048="2048" 4096="4096"}
...
#define HIDE_VANILLA_BLOB_SHADOWS //[] compile "Hide Old Round Shadows"

// Taps per side (real count is double, +/- pairs). Powers of two so each tier doubles the cost.
#define SHADOW_SAMPLES 8 //[2 4 8 16] compile "Shadow Quality" {2="Low" 4="Medium" 8="High" 16="Ultra"}
