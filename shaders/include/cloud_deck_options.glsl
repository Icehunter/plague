...
#define u_CloudFadeCumulus 256.0 //[1.0..512.0 step 1.0] runtime "Cumulus Fade Distance (Chunks)"
#define u_CloudFadeStratus 64.0 //[1.0..512.0 step 1.0] runtime "Stratus Fade Distance (Chunks)"
#define u_CloudFadeStratocumulus 256.0 //[1.0..512.0 step 1.0] runtime "Stratocumulus Fade Distance (Chunks)"
#define u_CloudFadeNimbostratus 128.0 //[1.0..512.0 step 1.0] runtime "Nimbostratus Fade Distance (Chunks)"
#define u_CloudFadeAltocumulus 256.0 //[1.0..512.0 step 1.0] runtime "Altocumulus Fade Distance (Chunks)"
#define u_CloudFadeCirrocumulus 256.0 //[1.0..512.0 step 1.0] runtime "Cirrocumulus Fade Distance (Chunks)"
#define u_CloudFadeCirrus 256.0 //[1.0..512.0 step 1.0] runtime "Cirrus Fade Distance (Chunks)"
