...
#define u_BumpStrength 1.45 //[0.0..2.0 step 0.05] runtime "Bump Strength"
// Defaults match terrain.fsh's plaguePomDistanceFade: 32 steps put the 0.75x/1.5x fade band at
// 24..48 blocks.
#define u_PomDepth 0.18 //[0.0..2.0 step 0.01] runtime "Bump Depth"
#define u_PomQuality 32.0 //[0.0..256.0 step 8.0] runtime "Bump Quality"
#define u_PomDistance 32.0 //[16.0..512.0 step 8.0] runtime "Bump Distance"
#define u_PomAllowCutout 1 //[0 1] runtime "Bump on Cutout Blocks" {0="Off" 1="On"}
#define u_PomShadowStrength 0.6 //[0.00..1.00 step 0.05] runtime "Bump Shadows"
#define u_PomDebug 0 //[0 1 2 3] runtime "Test View: Bump Mapping" {0="Off" 1="Height" 2="Shadow" 3="Travel"}
...
#define u_AlbedoIdentityDebug 0 //[0 1] runtime "Test View: Surface Colour" {0="Off" 1="On"}
...
#define u_AOStrength 1.0 //[0.0..1.0 step 0.05] runtime "Corner Shading Strength"
...
#define u_RefractStrength 0.32 //[0.0..1.0 step 0.01] runtime "Glass Warp Strength"

#define u_SnowAmount 1.0 //[0.25..2.0 step 0.05] runtime "Snow Amount"
#define u_SplashDensity 0.6 //[0.2..1.0 step 0.05] runtime "Splash Amount"
