...
// 24..48 blocks.
#define u_PomDepth 0.18 //[0.0..2.0 step 0.01] runtime "Parallax Depth"
#define u_PomQuality 32.0 //[0.0..256.0 step 8.0] runtime "Parallax Quality"
#define u_PomDistance 32.0 //[16.0..512.0 step 8.0] runtime "Parallax Distance"
#define u_PomAllowCutout 1 //[0 1] runtime "Parallax on Cutout Blocks" {0="Off" 1="On"}
#define u_PomShadowStrength 0.6 //[0.00..1.00 step 0.05] runtime "Parallax Shadows"
#define u_PomDebug 0 //[0 1 2 3] runtime "Test View: Parallax" {0="Off" 1="Height" 2="Shadow" 3="Travel"}
