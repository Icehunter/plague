...
#define PLAGUE_AIR_SHADOW_DEBUG 0 //[0 1] compile "Air Shadow Coverage" {0="Off" 1="On"}
...
#define u_AirShadowProbeDistance 96.0 //[16.0..512.0 step 16.0] runtime "Air Probe Distance (Blocks)"
